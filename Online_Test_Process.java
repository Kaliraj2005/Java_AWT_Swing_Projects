...
import javax.swing.*;
class Online_Test_Process extends JFrame implements ActionListener
{
    JLabel l;
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getActionCommand().equals("Result"))
        {
            ...
            JOptionPane.showMessageDialog(this,"crt ans="+count);
            System.exit(0);
        }
    }
    void set()
    {
        ...
        if(current==0)
        {
            l.setText("Q.1 : Which one among these is not a datatype");
            jb[0].setText("int");
            jb[1].setText("Float");
    ...
    {
        new Online_Test_Process("Online Test from Java");
    }
}
